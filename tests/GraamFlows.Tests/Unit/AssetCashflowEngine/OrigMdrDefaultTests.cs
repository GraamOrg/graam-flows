...
/// <summary>
/// ORIGMDR default-basis tests. Consumer-ABS loss tapes quote default as a
/// monthly percentage of the ORIGINAL balance, so a flat rate produces
/// constant-dollar defaults every period — unlike <see cref="DefaultTypeEnum.MDR"/>,
/// a hazard on the CURRENT performing balance whose dollar default shrinks as
/// the pool amortizes.
///
