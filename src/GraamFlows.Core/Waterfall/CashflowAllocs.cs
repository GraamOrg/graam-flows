...
{
    private static readonly CashflowAllocs _empty = new(0, 0, 0, 0);

    public CashflowAllocs(double schedPrin, double prepayPrin, double recovPrin, double writedown)
    {
        SchedPrin = schedPrin;
